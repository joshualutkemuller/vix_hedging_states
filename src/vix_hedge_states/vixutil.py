...
import download_vix_futures as vix_utils
from vix_cash_term_structure import get_vix_index_histories, pivot_spot_term_structure_on_symbol
...
def main():
    ...
    vix_spot=get_vix_index_histories()
    vix_monthly_futures_wide=vix_utils.pivot_futures_on_monthly_tenor(vix_futures)
    vix_spot_wide=pivot_spot_term_structure_on_symbol(vix_spot)
